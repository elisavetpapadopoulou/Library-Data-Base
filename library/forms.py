...
class category_statistics_form(FlaskForm):
    category = SelectField('Category', validators=[DataRequired(message="Category is a required field.")],
                        choices=[('Science Fiction', 'Science Fiction'), ('Mystery', 'Mystery'), 
                                 ('Self-help', 'Self-help'),  ('Thriller', 'Thriller'), 
                                 ('Fantasy', 'Fantasy'), ('Fiction', 'Fiction'), ('Biography', 'Biography')])
    submit = SubmitField("Search")
